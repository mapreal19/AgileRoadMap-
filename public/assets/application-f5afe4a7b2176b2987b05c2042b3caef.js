...
(function() {
  ...
  DOMParser = (function() {
    ...
    DOMParser.prototype._get_parser = function() {
      var _ref;
      return (_ref = this._document_parser) != null ? _ref : this._document_parser = this._parser_factory();
    };
    ...
    if ((_ref = window._Wiselinks) != null) {
    _ref;
  } else {
    window._Wiselinks = {};
  };
...
(function() {
  ...
  Response = (function() {
    ...
    Response._get_document_parser = function() {
      var _ref;
      return (_ref = Response._document_parser) != null ? _ref : Response._document_parser = new window._Wiselinks.DOMParser;
    };
    ...
    Response.prototype.content = function() {
      var _ref;
      return (_ref = this._content) != null ? _ref : this._content = this._extract_content();
    };

    Response.prototype.title = function() {
      var _ref;
      return (_ref = this._title) != null ? _ref : this._title = this._extract_title();
    };
    ...
    Response.prototype.description = function() {
      var _ref;
      return (_ref = this._description) != null ? _ref : this._description = this._extract_description();
    };
    ...
    Response.prototype._get_doc_target_node = function() {
      var _ref;
      return (_ref = this.$doc_target_node) != null ? _ref : this.$doc_target_node = $(this.$target.selector, this._get_doc());
    };

    Response.prototype._get_doc = function() {
      var _ref;
      return (_ref = this._doc) != null ? _ref : this._doc = Response._get_document_parser().parse(this.html);
    };
...
var image_path_up = "/assets/up.png"

var scrolltotop={
	//startline: Integer. Number of pixels from top of doc scrollbar is scrolled before showing control
	//scrollto: Keyword (Integer, or "Scroll_to_Element_ID"). How far to scroll document up when control is clicked on (0=top).
	setting: {startline:100, scrollto: 0, scrollduration:1000, fadeduration:[500, 100]},
	controlHTML: '<img src=' + image_path_up + ' style="width:51px; height:42px" />', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
  ...
  jQuery(function() {
    ...
    return App.sort = sort = function() {
      ...
      updateRowIndex = function() {
        var $fila, fila, filas, new_index, _i, _len, _results;
        filas = $('.item');
        _results = [];
        for (_i = 0, _len = filas.length; _i < _len; _i++) {
          fila = filas[_i];
          $fila = $(fila);
          new_index = $fila.index() + 1;
          _results.push($(fila).find('td.orden').first().text(new_index));
        }
        return _results;
      };
...
(function() {
  jQuery(function() {
    var sort_objetivo;
    return App.sort_objetivo = sort_objetivo = function() {
      ...
      return $('#tabla_objetivos').sortable({
        axis: 'y',
        items: '.item-objetivo',
        handle: ".handle",
        stop: function(e, ui) {
...
(function() {
  jQuery(function() {
    var autosizeTextArea, noAplicableCheckBox, noMargenCheckBox, objetivoClick, practicaClick, toggleTablaObjetivos, updateAplicableCheckBox, updateComment, updateRange;
    App.autosizeTextArea = autosizeTextArea = function() {
      return $('textarea.comment').autosize();
    };
    App.toggleTablaObjetivos = toggleTablaObjetivos = function() {
      return $('#toggle_objetivos').click(function() {
        ...
        return $('#tabla_objetivos tr.active').removeClass('active');
      });
    };
    App.noMargenCheckBox = noMargenCheckBox = function() {
      return $("#no_margen").change(function() {
        if (this.checked) {
          return $(".no-margen").fadeOut("slow");
        } else {
          return $(".no-margen").fadeIn("slow");
        }
      });
    };
    App.noAplicableCheckBox = noAplicableCheckBox = function() {
      return $("#no_aplicable").change(function() {
        console.log('changed checkbox no_aplicable');
        if (this.checked) {
          return $(".no-aplicable").fadeOut("slow");
        } else {
          return $(".no-aplicable").fadeIn("slow");
        }
      });
    };
    App.updateAplicableCheckBox = updateAplicableCheckBox = function() {
      return $(".no-aplicable-checkbox").change(function() {
        var $this, fila_practica, item_id;
        $this = $(this);
        fila_practica = $this.parent().parent();
        item_id = fila_practica.data('item-id');
        if (this.checked && $('#no_aplicable').is(':checked')) {
          fila_practica.fadeOut("slow", function() {
            return fila_practica.addClass("no-aplicable");
          });
        ...
        return $.ajax({
          ...
          data: {
            id: item_id,
            user_practica: {
              no_aplicable: this.checked
            }
          }
        });
      });
    };
    App.updateRange = updateRange = function() {
      return $(".range").change(function() {
        var $this, fila_practica, item_id, range_new;
        $this = $(this);
        fila_practica = $this.parent().parent();
        item_id = fila_practica.data('item-id');
        range_new = $this.val();
        ...
        if (range_new === "0" && $('#no_margen').is(':checked')) {
          fila_practica.fadeOut("slow", function() {
            return fila_practica.addClass("no-margen");
          });
        } else if (range_new === "0") {
    ...
    App.updateComment = updateComment = function() {
      return $(".comment").blur(function() {
        var $this, comment_new, item_id;
        $this = $(this);
    ...
    App.objetivoClick = objetivoClick = function() {
      var valoresContribucion;
      valoresContribucion = {
        1: 'Muy Baja',
        2: 'Baja',
        3: 'Media',
      ...
      return $(".ver-practica").click(function() {
        var $this, id, ids, _i, _len;
        $this = $(this);
    ...
    App.practicaClick = practicaClick = function() {
      return $(".ver-practicas-relacionadas").click(function(e) {
        var $this, id, ids, _i, _len;
        $this = $(this);
    ...
    App.resetFilasTablaPracs = function() {
      $('.practica').removeClass("success");
      $('.contribucion').remove();
      return $('.valor-contribucion').remove();
    };
    App.resetFilasRelPracs = function() {
      $('.practica.active .practica-eye-close').hide();
      $('.practica.active .practica-eye-open').show();
      return $('.practica').removeClass("resaltado active");
    };
    return App.resetTablaObjetivos = function() {
      $('.objetivo.active .objetivo-eye-close').hide();
      $('.objetivo.active .objetivo-eye-open').show();
      return $('.objetivo').removeClass("active");
    };
  });
...
(function() {
  $(document).ready(function() {
    ...
    return $(document).off('page:done').on('page:done', function(event, $target, status, url, data) {
      App.init();
      App.initSliders();
      Index.initParallaxSlider();
