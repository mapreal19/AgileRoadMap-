...
Practica.create!({id: 40, position: 1, name: "Promover la sencillez en todos los aspectos. Ofrecer \
	...
	description: "Promover la sencillez en todos los aspectos. Ofrecer la solución más simple y mínima que pueda ser satisfactoria para el cliente, (Extreme Programming, Lean). Ejemplo de situación con la anti-práctica es el siguiente: el cliente y el equipo se esmeran en conseguir una primera versión del producto demasiado ambiciosa en cuanto a las características que incluye y/o en cuanto al nivel de complejidad o sofisticación en el que se ofrecerán algunas de dichas características. Hasta que el producto no se comience a utilizar no se tendrá una apreciación precisa del nivel de uso de las características del producto y de la utilidad que ellas ofrecen. Para evitar desperdicio de esfuerzo en desarrollo de características poco utilizadas o subutilizadas respecto de toda su funcionalidad implementada es preferible limitarse (al menos durante la generación de un producto) a trabajar con el diseño más sencillo que resuelve la necesidad del cliente y con el mínimo conjunto de características que pueden constituir un producto útil para el cliente. Esta práctica es mencionada como \"Diseño simple\" en Extreme Programming, y en Lean Development está práctica está alineada con el principio de eliminación de desperdicios, en este caso referido a trabajo que es prescindible y/o que no es valorado por el cliente. Un término muy en sintonía con esta práctica es el de Minimun Viable Product (MVP), u otro también similar llamado Minimum Markeable Features (MMF), los cuales se refiere al conjunto más pequeño posible de características del producto o servicio que por sí mismas podrían aportar valor, constituyendo por ejemplo, una primera entrega de un producto o una primera versión de una nueva funcionalidad de cierta envergadura. En una estrategia similar encontramos el Principio KISS (\"Keep it simple, stupid\") o el acrónimo YAGNI (\"You aren't gonna need it\"), el primero insiste en no sofisticar las soluciones y el otro en contener la ambición de añadir en el momento actual elementos no imprescindibles, y que incluso en el futuro podrían no ser necesarios. Otro aspecto interesante y relacionado con esta práctica se menciona entre los 7 Mudas (fuentes de desperdicio) de Lean Manufacturing, enunciado como: \"Sobre-proceso: Trabajo o servicio adicional no percibido por el cliente\", es decir, un esfuerzo invertido que no llega a ser valorado por el cliente." ,
...
Practica.create!({id: 1, position: 2, name: "Abordar y entregar trabajo terminado de forma incremental.", 
	description:'Abordar y ofrecer trabajo terminado de forma incremental, (Scrum, Extreme Programming). Un ejemplo de una situación con la anti-práctica es el siguiente: abordar el desarrollo de un producto como un todo, concentrando todo análisis en un período, luego su diseño, implementación, etc., y haciendo una sola entrega al final. Esto corresponde a un enfoque de proceso secuencial o en cascada (si hay algo de solape entre las actividades). No trabajar de forma incremental entraña un alto riesgo, especialmente si el alcance es grande, es decir, cuando solo después de realizar una gran inversión de tiempo o recursos se producirá la entrega que el cliente podrá explotar. Dicho riesgo se asocia a que lo definido inicialmente o con demasiada anticipación cambie antes de la entrega y obligue a hacer re-trabajo para alinear el resultados a los cambios. Un enfoque incremental requiere una definición preliminar de cada unidad de trabajo, pero solo el suficiente para su priorización, dejando la definición completa para el momento justo antes de realizar el trabajo.', 
...
Practica.create!({id: 25, position: 4, name: "Realizar reuniones de planificación frecuentemente (frecuencia \
	...
	description:'Realizar reuniones de planificación frecuentemente (frecuencia de pocas semanas, no meses), (Scrum, Extreme Programming). En un contexto ágil se asume que la planificación puede cambiar para adecuarse a los cambios que se presenten, con lo cual el plan aunque conlleva compromisos de fechas y recursos, debería permitir cambios en cuando a alcance, para adaptarse a cambios de prioridades y cambios en la definición del trabajo.Un ejemplo de una situación con la anti-práctica es el siguiente: planificar intensamente al comienzo del proyecto y para un horizonte a mediano o largo plazo. En proyectos con muchos cambios durante su realización conviene planificar a corto plazo en detalle y a largo plazo hacerlo de forma global lo suficiente para gestionar el alcance. Lectura recomendada: Gestión ágil del alcance en un proyecto ágil.', 
...
Practica.create!({id: 34, position: 5, name: "Acotar el trabajo previsto para un período en base a su estimación \
	...
	description:'Acotar el trabajo previsto para un período en base a su estimación y correspondiente coherencia con la capacidad del equipo, (Scrum, Extreme Programming). Un ejemplo de una situación con la anti-práctica es el siguiente: comprometer un conjunto de trabajo que a priori ya se sabe que no será posible terminarlo en el plazo establecido. Si el equipo no tiene una noción fiable de su capacidad (cantidad de trabajo que puede ser abordado con éxito en un período), cada vez que tenga que hacer una previsión o compromiso de trabajo correrá el riesgo de tener diferencias significativas con los datos reales del trabajo una vez efectuado. Es importante destacar que dependiendo del contexto la estimación del trabajo puede ser realizada con menor intensidad o solo de forma parcial, incluso puede prescindirse de ella. Además, la estimación de un trabajo no es una actividad aislada, siempre estará asociada a la definición del trabajo (definición que siempre debe hacerse en alguna medida), con lo cual estimar no debería representar un esfuerzo adicional significativo. La estimación podría considerarse obligatoria solo si la relación con el cliente involucra un contrato o acuerdo rígido respecto del alcance, plazos y recursos.. Lectura recomendada: Estimación Ágil, parte I y parte II).', 
...
Practica.create!({id: 41, position: 6, name: "Organizar el trabajo en iteraciones que agrupan unidades de trabajo \
	...
	description:'Organizar el trabajo en iteraciones que agrupan unidades de trabajo que son entregadas en una fecha prevista, (Scrum, Extreme Programming). Esta práctica es esencial en Scrum y Extreme Programming, ambos métodos proponen un proceso iterativo. En Scrum se denominan Sprints a las iteraciones. En Scrum un Sprint no debería durar más de cuatro semanas, en Extreme Programming se sugieren que no sean más de tres semanas. Esta práctica está condicionada a que efectivamente se pueda e interese agrupar el trabajo para prever o comprometer entregas asociadas a grupos de trabajo terminado. Esta situación es natural cuando se está desarrollando una primera entrega del producto o una entrega asociada a una modificación de gran envergadura, y cuando además dicha entrega podría tardar más de un mes. Esta práctica no es aplicable en situaciones en las cuales el equipo no puede agrupar el trabajo para acordarlo con el cliente o ni siquiera puede anticipar cuál es el trabajo que hará en el corto plazo. Un ejemplo de la situación con la anti-práctica es el siguiente: el equipo acuerda con el cliente una fecha de entrega en varios meses por delante sin tener la posibilidad de retroalimentación parcial respecto del trabajo realizado hasta cierto momento. La organización del trabajo en Sprints, además de ayudar al equipo y al cliente a confirmar que el trabajo va bien encaminado, ofrece otras ventajas tales como: establecer una "cadencia" o ritmo continuo de trabajo que favorece la fiabilidad del equipo, o realización de actividades que conviene aplicarlas en conjunto para un grupo de unidades de trabajo en lugar de hacerlas individualmente para cada una de ellas (tales como: documentación, pruebas de regresión, formación, instalación, etc.).', 
...
Practica.create!({id: 50, position: 7, name: "Evitar invertir esfuerzo en adelantar trabajo que no esté comprometido \
	...
	description:'Evitar adelantar trabajo que no esté comprometido y/o no esté cercano a su entrega, (Lean). Esta práctica está inspirada en uno de los 7 Mudas (fuentes de desperdicio) de Lean Manufacturing, enunciado como: "Sobre-producción: producir mucho o con demasiada antelación". En procesos de desarrollo de software (o en ciertos servicios)  la consecuencia o problema de NO aplicar esta práctica no es tan evidente como en procesos que generan un producto físico, en los cuales se delata claramente la acumulación de unidades de trabajo terminadas y no entregadas (vendidas) al cliente, que probablemente provocará niveles de inventario no deseables en algunos puntos de la cadena de producción. Pero además de dicha posible acumulación de trabajo en curso o terminado, más grave aún puede ser el hecho que el trabajo adelantado llegue a quedar obsoleto y tenga que realizarse re-trabajo para actualizarlo, o incluso tenga que desecharse. Ejemplo de situación con la anti-práctica es el siguiente: un equipo de desarrollo, en la medida que va recibiendo solicitudes de cambios en un producto software las va analizando en detalle y validando con el cliente. Luego resulta que por cuestiones de oportunidad de negocio, por otros cambios implementados previamente o por nuevos cambios solicitados, las solicitudes de cambios ya preparadas van perdiendo prioridad o simplemente quedan obsoletas respecto del estado actual del producto. La respuesta acertada a ¿cuándo convendría (y en qué medida) adelantar el comienzo de un trabajo? dependerá del contexto del producto o servicio (y de la unidad de trabajo en sí misma), pero esta práctica nos advierte en general del riesgo que conllevará invertir ese esfuerzo por adelantado.', 
...
Practica.create!({id: 44, position: 8, name: "Organizar el trabajo del equipo con el foco en la generación de un buen \
	...
	description:'Organizar el trabajo del equipo con el foco en la generación de un buen flujo de trabajo terminado, (Kanban). Cuando no se puede anticipar cuál es el trabajo que recibirá el equipo y no se quiere acumular trabajo para ser agrupado y establecer un plazo de entrega, o bien cuando se quiere dar una rápida respuesta a las solicitudes del cliente, especialmente a las pequeñas (que en caso de planificarse podrían verse aplazadas), en estos casos, el equipo se debería centrar en generar un buen flujo de trabajo terminado. Así pues, con esta práctica el trabajo en la medida que se recibe se ordena con respecto del resto de trabajo pendiente, y respetando dicho orden se va abordando. Esta práctica es se presenta en el método Kanban con la idea de favorecer el flujo continuo de trabajo terminado, utilizando métricas de flujo tales como: unidades terminadas por unidad de tiempo (Production Rate), Cycle Time (tiempo promedio que tarda una unidad de trabajo en ser procesada hasta terminarse), y Lead Time (tiempo promedio que tarda una unidad de trabajo desde que se solicita hasta que se entrega). Un ejemplo de situación con la anti-práctica es el siguiente: el equipo se esfuerza en vano intentando planificar el trabajo, en agruparlo, en contrastarlo con su capacidad y en negociarlo con el cliente, siendo que continuamente va recibiendo nuevos trabajos que obligan a re-planificar. Si frecuentemente lo planificado difiere significativamente de lo que realmente se realiza, es cuestionable el esfuerzo invertido en la planificación y tareas asociadas. Sin embargo, esto no significa renunciar a evaluar cada trabajo que entra respecto del trabajo pendiente. Esto es crucial que todo el trabajo pendiente (incluyendo el recién llegado) esté siempre ordenado (debe priorizarse siguiendo los criterios que el cliente estime conveniente) para que el equipo lo vaya abordando en dicho orden.', 
...
Practica.create!({id: 45, position: 11, name: "Formar equipos pequeños y procurar que mantengan sus integrantes.", 
	description:'Formar equipos pequeños y procurar que mantengan sus integrantes, (Scrum, Extreme Programming). Las prácticas ágiles intensifican la comunicación y coordinación frecuente en los equipos de trabajo, y se prefiere que se dichas actividades se realicen cara a cara. Esto es difícil de llevar a cabo si el equipo es de gran tamaño. Scrum sugiere que los equipos deberían estar formados por entre 3 y 9 integrantes. Por otra parte, es importante que el equipo en lo posible se mantenga estable en cuanto a sus integrantes puesto que el equipo irá ganando cohesión. Un ejemplo de situación con la anti-práctica es el siguiente: cada vez que se plantea el desarrollo de un nuevo producto o un cambio significativo en un producto ya existente se arma un nuevo equipo de trabajo para abordar dicho proyecto, cogiendo personas desde equipos ya formados. Los equipos requieren un tiempo para llegar a un nivel adecuado de compenetración, para abordar inmediatamente un nuevo proyecto puede resultar más efectivo cambiar el ámbito de trabajo de un equipo ya formado que formar un nuevo equipo, especialmente si se quiere un respuesta rápida y fiable. Además, la frecuente rotación de integrantes puede afectar el desempeño de los equipos.', 
...
Practica.create!({id: 3, position: 13, name: "Seguimiento continuo (frecuencia de días, no semanas).", 
	description:'Seguimiento continuo (frecuencia de días, no semanas), (Scrum, Extreme Programming  Kanban). La intensidad y frecuencia del seguimiento depende del contexto del trabajo, y en particular depende de si la demanda es o no planificable. Cuando la demanda NO es planificable el seguimiento se basará en la visualización del estado del trabajo y en métricas de flujo de trabajo terminado (por ejemplo, unidades de trabajo terminadas por unidad de tiempo, tiempo de procesamiento, o tiempo de entrega desde que se solicitó el trabajo). Si la demanda es en cierta medida planificable, adicionalmente como seguimiento podemos contrastar el progreso del trabajo con el trabajo restante para el período planificado, comprobando si es posible cumplir los acuerdos respecto de la entrega. Un ejemplo de una situación con la anti-práctica es el siguiente: hacer el seguimiento cada 2 o 3 semanas. Mientras menos frecuente sea el seguimiento mayor puede ser la desviación respecto de lo esperado, en proyectos en los cuales existen muchos cambios, el seguimiento continuo y frecuente es esencial. Además, es importante que el equipo al completo se interese por el seguimiento, tanto a nivel de las actividades encargadas a cada integrante como a nivel de los compromisos del equipo.', 
...
Practica.create!({id: 28, position: 14, name: "Realizar una reunión diaria del equipo al completo, cara a cara y \
	muy breve.", 
	description:'Realizar una reunión diaria del equipo al completo, cara a cara y muy breve, (Scrum, Extreme Programming . Esta reunión se llama "Stand-up Meeting" en Extreme Programming y "Daily Scrum" en Scrum, y se refiere a una reunión que realiza el equipo al iniciar su jornada de trabajo, es una reunión de pie en semi-círculo ojalá frente a la visualización de trabajo del equipo, y dura no más de 15 minutos. Un ejemplo de una situación con la anti-práctica es el siguiente: el equipo solo se reúne al completo y cara a cara al comienzo y al final del proyecto o al alcanzar algún hito, dejando mucho tiempo sin reunirse todos. El propósito de estas reuniones es que todo el equipo esté enterado de lo que se está haciendo y sus posibles impedimentos, promoviendo la colaboración entre los miembros del equipo y reforzando el compromiso con los objetivos del equipo, por sobre las responsabilidades individuales.', 
...
Practica.create!({id: 30, position: 16, name: "Gestión integrada de todo el trabajo asignado, tanto a nivel del equipo \
	...
	description:'Gestión integrada de todo el trabajo asignado, tanto a nivel del equipo como a nivel de cada miembro. (Kanban, Scrum). Un ejemplo de una situación con la anti-práctica es el siguiente: se le asigna un trabajo a un miembro o a un equipo sin contrastarlo con el trabajo que ya tiene asignado y sin proporcionar pautas respecto a las correspondientes prioridades. La gestión integrada del trabajo pendiente y de su priorización es el primer paso para conseguir que los miembros del equipo estén siempre trabajando en lo más oportuno. Si bien no es lo ideal que un equipo o integrante trabaje en varios productos y/o servicios, es una situación bastante usual y difícil de cambiar. Esto provoca que la gestión integrada de todo el trabajo del equipo sea un desafío, pues un simple tablero kanban de pared probablemente no será suficiente, una opción más adecuada es disponer de una herramienta software que ofrezca soporte para gestionar de forma integrada varios tableros kanban. Lecturas recomendadas: Agilismo en un contexto multi-proyecto, parte I y parte II.', 
	effort: 4, ambito_decision: 'equipo', agile_method: "" })
Practica.create!({id: 9, position: 17, name: "Cliente en estrecho contacto con el equipo y altamente disponible, \
	...
	description:'Cliente en estrecho contacto con el equipo y altamente disponible, incluso si es posible, que esté in-situ (Scrum, Extreme Programming). Un ejemplo de una situación con la anti-práctica es el siguiente: el equipo debe pedir reuniones al cliente para aclarar cuestiones respecto del problema que solicitó resolver, esto conlleva esperar horas o días, con lo cual se producen retrasos y obliga a que mientras tanto se trabaje en otras cosas, penalizando el  rendimiento del equipo por los cambios de contexto al cambiar de trabajo.', 
	effort: 5, ambito_decision: 'producto/servicio', agile_method: "XP, Scrum"})
Practica.create!({id: 18, position: 18, name: "Que exista una única persona que tome las decisiones respecto de las \
	...
	description:'Que exista una única persona que tome las decisiones respecto de las prioridades del trabajo del equipo y que sea un buen representante de la parte cliente. (Scrum). Un ejemplo de una situación con la anti-práctica es el siguiente: el equipo, incluso cualquiera de sus miembros recibe solicitudes de diferentes clientes para resolver sus particulares necesidades, y deben ellos mismos establecer las prioridades para organizar su dedicación a cada solicitud de trabajo. Se debería "proteger" al equipo del ruido que le puede suponer su exposición directa a las solicitudes de los clientes y al despropósito que conllevaría que el equipo tome decisiones de negocio (prioridades de las solicitudes). Así pues, es importante establecer una barrera entre el día a día del equipo y la nueva demanda que se va generando, debe existir un solo interlocutor que represente a la parte cliente y que le proporcione al equipo las prioridades del trabajo pendiente.', 
...
Practica.create!({id: 26, position: 19, name: "Realizar reuniones de revisión del trabajo entregado", 
	description:'Realizar reuniones de revisión del trabajo entregado, (Scrum). Estas reuniones corresponden a las "Review Meetings" de Scrum. En estas reuniones el equipo se reúne con representantes de la parte cliente para presentar el trabajo realizado. Un ejemplo de una situación con la anti-práctica es el siguiente: si bien el equipo cumple con los plazos y compromisos, esto pasa desapercibido para el cliente (existen casos en los que incluso el cliente llegar a solicitar algo ya realizado por desconocer que ya está hecho). Estas reuniones debe servir para remarcar el cumplimiento de lo acordado con el cliente, es importante que el equipo tenga esta oportunidad para "lucir" y divulgar el trabajo realizado.', 
...
Practica.create!({id: 13, position: 20, name: "El equipo se auto-organiza y toma las decisiones técnicas", 
	description:'El equipo se auto-organiza y toma las decisiones técnicas. (Scrum). Proviene del concepto "self-organizing team" de Scrum. Un ejemplo de una situación con la anti-práctica es el siguiente: los miembros del equipo están acostumbrados a recibir instrucciones respecto de qué deben hacer, cuándo y cómo, careciendo de iniciativa o evitando asumir decisiones técnicas en el trabajo.', 
	effort: 4, ambito_decision: 'equipo', agile_method: "Scrum"})
Practica.create!({id: 37, position: 21, name: "Jefe de carácter líder y facilitador en lugar de actitud del jefe \
	...
	description:'Cambiar la actitud del jefe desde un jefe autoritario hacia otro más de carácter líder y facilitador. (Extreme Programming, Scrum). Un ejemplo de una situación con la anti-práctica es el siguiente: el jefe del proyecto asigna el trabajo a cada miembro del equipo y controla su progreso. Situaciones como estas desbordan a los jefes de proyecto en desmedro de su desempeño en la gestión global del proyecto, comunicación con la parte cliente y con los niveles de dirección superiores. El planteamiento de Scrum es radical al respecto: no existe el rol de jefe. El rol  Producto Owner incluye las responsabilidades de: representar a la parte cliente, definir y priorizar el trabajo, organizando qué trabajo debe abordar el equipo. Es rol Scrum Master se encarga de apoyar en cuanto a la implantación y correcta aplicación de la metodología de trabajo y de su mejora continua. Ni el Product Owner ni el Scrum Master indican al equipo quién o cómo debe llevar a cabo el trabajo técnico. En Extreme Programming existe el rol Manager, caracterizado como facilitador, encargado de resolver inconvenientes que pueda tener el equipo para realizar su trabajo. El planteamiento de Scrum, si bien es ideal, es difícil de implantar, al menos en contextos donde el rol de jefe tradicional está muy arraigado. El plantemiento de Extreme Programming respecto del rol Manager ofrece menos resistencia y podría servir de evolución hacia al escenario de Scrum.', 
...
Practica.create!({id: 5, position: 22, name: "Co-localización de los miembros del equipo, todo el equipo trabajando \
	...
	description:'Co-localización de miembros del equipo, todo el equipo trabajando en el mismo espacio físico, (Extreme Programming). Un ejemplo de situación con la anti-práctica sería: un miembro del equipo requiere comentar alternativas de solución para un trabajo que está realizando, si se trata de algo complicado de explicar por chat, email o videoconferencia, lo más efectivo sería tener una reunión inmediata para no tener que parar su trabajo, pero esto no es posible porque el equipo no está físicamente en el mismo sitio. Si bien contando con las actuales alternativas de comunicación, especialmente videoconferencias, puede compensarse en gran medida los inconvenientes de no tener un contacto cara a cara in-situ, difícilmente se consigue la misma eficacia de comunicación del contacto in-situ, pues los aspectos gestuales o en general la comunicación no verbal no se consigue transmitir completamente.', 
...
Practica.create!({id: 49, position: 23, name: "Contar con un espacio físico de trabajo que favorezca la interacción \
	...
	description:'Contar con un espacio físico de trabajo que promueva y favorezca la interacción entre los miembros del equipo, (Extreme Programming, Lean). Si bien no es una de las 12 prácticas de Extreme Programming, allí donde se pone énfasis en el espacio de trabajo del equipo, un espacio abierto (sin módulos), sillas con ruedas, pizarras en las paredes, un área para hablar por teléfono, un área para comer y conversar informalmente, etc. En el contexto Lean también el espacio de trabajo, referido como el "Gemba", tiene cierto protagonismo. Un ejemplo de situación con la anti-práctica sería:  un equipo trabajando en un espacio organizado en cubículos y sin un área cercana para poder improvisar una reunión, lo cual no favorece para que los miembros de forma natural se animen a comunicarse cara a cara. Por contraparte, el extremo opuesto lo constituiría lo que se denomina "War room", un espacio relativamente reducido sin ninguna delimitación de espacios individuales, y en el cual el equipo, ante una situación de emergencia podría, basándose en una interacción codo-a-codo, daría una pronta solución a un problema. Entre estos extremos hay un amplio abanico de alternativas, y si bien la intención debería ser alejarse del extremo asociado a un espacio con cubículos, también hay que considerar que un "War room", aunque puede ser efectivo en situaciones puntuales y por períodos cortos, no sería recomendable como espacio de trabajo habitual.', 
...
Practica.create!({id: 47, position: 24, name: "Establecer y comunicar al equipo la visión del producto o servicio, \
	...
	description:'Establecer y comunicar al equipo la visión del producto o servicio, y reforzarla regularmente, (--). La Visión de un producto o servicio es básicamente su información respecto de: propósito y motivación,  principales características, tipos de usuarios, productos o servicios competidores, fortalezas y debilidades, amenazas y oportunidades. Si bien en un enfoque tradicional la recolección y especificación de esta información podría tomar un tiempo considerable y generar un documento voluminoso. Desde una perspectiva más ágil la idea sería conseguir un documento muy simplificado, con lo esencial, o bien podría bastar con que el equipo esté en conocimiento de dicha información aunque no esté explícitamente escrita. En Extreme Programming la práctica Metáfora tiene un propósito similar a la Visión, y consiste en que el equipo conozca y sea capaz de relatar lo esencial del producto que se está desarrollando. En Scrum el concepto de Goal del sprint también tiene algo en común con la Visión, y permite destacar dentro de todo el trabajo de un sprint aquello que es lo esencial, representado por algunos de los ítems del sprint. Conocer la Visión del producto le proporciona al equipo un contexto para su trabajo, lo cual debería influir positivamente en su motivación y compromiso. Un ejemplo de situación con la anti-práctica sería: un equipo desconcertado por las prioridades establecidas por el cliente (que obviamente deberían estar alineadas con la Visión) y correspondientemente menos comprometido o motivado por no comprender el aporte de su trabajo al éxito del producto o servicio.', 
...
Practica.create!({id: 42, position: 26, name: "Que los integrantes del equipo puedan encargarse de diferentes tipos \
	...
	description:'Que los integrantes del equipo no tengan solo algunas actividades fijas asignadas, que puedan encargarse de diferentes tipos de actividades (ojalá de todas), aunque puedan ser especialistas en alguna(s) de ellas, (--). Un ejemplo de la situación con la anti-práctica es el siguiente: el único integrante del equipo que realiza una determinada actividad no está disponible o tiene demasiado trabajo en dicha actividad, los otros integrantes del equipo no pueden echar una mano porque no trabajan en esta actividad, debido a esto la actividad se convierte en un cuello de botella para el proceso. Sin descartar la especialización y los beneficios que ella conlleva, siempre hay trabajos de menor tamaño/complejidad en los cuales no es imprescindible un alto grado de especialización en la actividad que debe realizarse. En este caso podría encargarse de ellos cualquier integrante del equipo, o al menos colaborar con el especialista trabajando bajo su supervisión. Los métodos ágiles promueven los roles más genéricos para acotar lo menos posible las actividades que puede desempeñar un integrante del equipo. En Scrum en el equipo sólo existe el rol "Desarrollador" el cual se encarga de todo el trabajo técnico. En Extreme Programming respecto del trabajo técnico se reconoce el rol Programador (el cual desde la perspectiva tradicional sería un analista, programador y tester en los niveles unitario, de integración y de sistema), y el rol tester (encargado de las pruebas de aceptación). Obviamente, tener estos roles más genéricos puede entrar en conflicto con las estructura de puestos de la organización, en la cual se suele hacer énfasis en roles más específicos y en sus correspondientes escalas de remuneración.', 
	effort: 4, ambito_decision: 'equipo', agile_method: "Scrum"})
Practica.create!({id: 2, position: 27, name: "Trabajo centrado en satisfacer pruebas de aceptación acordadas \
	con el cliente.", 
	description:'Trabajo centrado en satisfacer pruebas de aceptación acordadas con el cliente, (Extreme Programming). Práctica aplicable más directamente en el ámbito del desarrollo y mantenimiento de  productos. Un ejemplo de situación con la anti-práctica es el siguiente: el equipo entrega un producto terminado al cliente pero éste lo rechaza porque no se comporta según lo esperado, el problema fue que por omisión o mala interpretación no se cumplen ciertas expectativas. Aunque aparentemente pareciera que es suficiente que una especificación del trabajo incluya una combinación de texto descriptivo y algunos modelos u otros complementos, si no se establece con precisión el criterio de aceptación desde la perspectiva del cliente siempre habrá lugar para dichas situaciones de no conformidad. Ese criterio de aceptación no es más ni menos que un conjunto de pruebas que el cliente aplicaría para considerarse satisfecho con la entrega. Con lo cual en el mismo momento de la definición del trabajo deben quedar establecidas y acordadas con el cliente las pruebas de aceptación. Lectura recomendada: Gestión ágil de requisitos.', 
...
Practica.create!({id: 4, position: 28, name: "Documentar, pero solo lo estrictamente necesario. Que sea rentable \
	...
	description:'Documentar, pero solo lo estrictamente necesario, que sea rentable el aprovechamiento de la documentación respecto del esfuerzo asociado a elaborarla, (Lean, Scrum, Extreme Programming . Un ejemplo de situación con la anti-práctica es el siguiente: exigido por el proceso establecido para toda la empresa el equipo se ve obligado a elaborar documentación que saben que no les resulta útil ni a ellos ni a quienes reciben la entrega. Suele ocurrir, especialmente en empresas grandes, donde se ha hecho una importante inversión para establecer una metodología de trabajo global, y para la cual no se hace una configuración adecuada a las necesidades de cada proyecto. Especialmente en proyectos pequeños se corre el riesgo de sobre-documentar. Lean Development insiste en eliminar toda forma de desperdicio ("waste"), es decir, trabajo que no aporta valor para el cliente. La documentación suele ser una fuente importante de desperdicio de esfuerzo. Cuando el trabajo sufre constantes cambios sobre la marcha, pretender mantener actualizada la documentación puede ser un gran desperdicio. La mínima especificación necesaria para llevar a cabo un trabajo es conocer el criterio de aceptación que aplicará el cliente, cualquier otra especificación requerida para la entrega podría generarse de forma detallada y completa una vez que el resultado adquiera cierta estabilidad, evitando o reduciendo dicho desperdicio.', 
...
Practica.create!({id: 27, position: 32, name: "Realizar reuniones de retrospectiva para evaluar el \
	...
	description:'Reuniones de retrospectiva para evaluar el desempeño del equipo y sus formas de trabajo. Mejora Continua, (Scrum). Estas reuniones corresponden a las "Retrospective Meetings" de Scrum. Un ejemplo de situación con la anti-práctica es el siguiente: no existe un mecanismo establecido y regular para que surja la auto-crítica respecto del desempeño del equipo y de su método de trabajo, esto hace que sólo después de problemas graves se reaccione tomando acciones preventivas o de mejora, muchas imperfecciones o ineficiencias conocidas pero no graves pueden mantenerse largo tiempo sin que lleguen a abordarse y buscarles solución.', 
...
Practica.create!({id: 12, position: 34, name: "Trabajo o actividades realizadas en conjunto por dos o más \
	integrantes", 
	description:'Trabajo o actividades realizadas en conjunto por dos o más integrantes. (Extreme Programming). Proviene de la práctica "Programación en Parejas" de Extreme Programming. Un ejemplo de una situación con la anti-práctica es el siguiente: si bien los miembros del equipo colaboran realizando diferentes actividades asociadas a una misma unidad de trabajo, no llegan a colaborar en una misma actividad, solo se van pasando entre ellos la unidad de trabajo para que cada uno realice la actividad encargada. Muchas veces cuando un trabajo es de cierta envergadura y/o complejidad para poder abordarlo entre varias personas se intenta a priori dividirlo, lo cual no suele ser sencillo y conlleva desafíos de coordinación. Una alternativa interesante y más sencilla en cuanto a coordinación es considerar que en algunas actividades trabaje más de una persona. Los encargados de realizar la actividad, al momento de llevarla a cabo podrían repartirse el trabajo si les resulta conveniente, pero con una coordinación resuelta en dicho momento y entre ellos.', 
...
Practica.create!({id: 35, position: 36, name: "Reducir las interrupciones o cambios de contexto que \
	...
	description:'Reducir las interrupciones o cambios de contexto que afectan en su trabajo a los miembros del equipo, (--). Un ejemplo de situación con la anti-práctica es el siguiente: un integrante del equipo para solucionar una duda respecto de su trabajo se acerca e interrumpe el trabajo de otro integrante y ambos mantienen una conversación de alrededor de media hora, cuando el miembro que ha sido interrumpido retoma su trabajo gasta bastantes minutos en volver a centrarse en lo que estaba realizando previamente. Deben existir unas pautas básicas para la utilización de los diversos medios de comunicación (cara a cara, mensajería instantánea, teléfono, videoconferencia, email o reuniones) para así conseguir un mejor desempeño global. La clave está en, por un lado, consensuar aproximadamente qué debe considerarse tan urgente como para justificar estas interrupciones sin optar por otra alternativa, y por otro, cuándo una interrupción no es tal, es decir, el integrante interrumpido realmente no se ve perjudicado por la interrupción ya sea por estar disponible o porque la interrupción es muy breve.', 
...
Practica.create!({id: 7, position: 37, name: "Establecer una disciplina de aprovechamiento de las reuniones", 
	description:'Establecer una disciplina de aprovechamiento de las reuniones, (--). La introducción de prácticas ágiles conlleva intrínsecamente mayor comunicación entre los miembros del equipo y con el cliente. El entusiasmo de los miembros del equipo ante lo que puede ser una oportunidad nueva de apertura a su participación y su aportación debe ser adecuadamente conducido. Gran parte de dicha comunicación y participación de canaliza a través de reuniones. Pero estas reuniones pueden llegar a ser muy improductivas si no existe una buena disciplina para llevarlas a cabo. Un ejemplo de situación con la anti-práctica es el siguiente: reuniones sin un buen moderador, sin la correcta elección de asistentes, sin una preparación o distribución de información anticipada, sin un registro de los acuerdos o sin ningún control respecto de su duración, con todo esto es difícil que una reunión sea eficiente y eficaz.', 
...
Practica.create!({id: 11, position: 40, name: "Integrar de forma continua en el producto el trabajo terminado", 
	description:'Integrar de forma continua en el producto o servicio el trabajo terminado, (Extreme Programming). Práctica aplicable más directamente en el ámbito del desarrollo y mantenimiento de productos. Proviene de la práctica "Integración Continua"de Extreme Programming. Un ejemplo de situación con la anti-práctica es el siguiente: los miembros del equipo van terminando partes del trabajo pero lo conservan sin integrarlo con el resto del trabajo, más tarde al integrar las diferentes unidades de trabajo en las que está trabajando el equipo aparecen inconvenientes no previstos, lo cual provoca retrasos que pueden tener consecuencias en la planificación especialmente cuando la integración se realiza cerca de cumplirse los plazos de entrega. Cuando varias personas colaboran en un trabajo solapándose en cuanto al resultado que debe obtenerse, y particularmente cuando se realizan cambios en paralelos en partes compartidas, es necesario gestionar los cambios y versiones de los artefactos generados, y además, tener una disciplina de integración continua para que todo el equipo disponga de la información más actualizada cuando está realizando su trabajo. Esto no solo es aplicable al ámbito del código fuente en un equipo de desarrollo de software sino también al trabajo colaborativo sobre cualquier tipo de documentos, en equipos de cualquier ámbito.', 
	effort: 3, ambito_decision: 'equipo', agile_method: "XP"})
